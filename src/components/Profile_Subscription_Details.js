...
function Profile_Subscription_Details() {
          ...
          <span>Standard plan for small to medium businesses</span>
                      ...
                      <div className="col-md-6">
                        <div className="alert alert-success mb-2" role="alert">
                          ...
                          <div className="alert-body fw-normal"> 3 </div>
                        </div>
                      </div>
                        ...
                        <div className="d-flex justify-content-between flex-sm-row flex-column">
                          <div className="card-information">
                            <img
                              ...
                              src="../../../app-assets/images/icons/payments/libyana.svg"
                              alt="Libyana"
                              width="80px"
                              height="80px"
                            />
                            <div className="d-flex align-items-center mb-50">
                              <h6>ليبيانا</h6>
                              {/* <h6 className="mb-0">ليبيانا</h6> */}
                              {/* <span className="badge badge-light-primary ms-50">الحالي</span> */}
                            </div>
            ...
            <div className="modal-body px-5 pb-2">
              ...
              <form id="upgradePlanForm" className="row pt-50" onsubmit="return false">
                <div className="col-sm-8">
                  <label className="form-label" htmlFor="choosePlan"> اختيار باقة</label>
                  <select id="choosePlan" name="choosePlan" className="form-select" aria-label="Choose Plan">
                    ...
                    <option value="Enterprise"> باقة ربع سنوية - 99دينار</option>
                  </select>
                </div>
                <div className="col-sm-4 text-sm-end">
                  <button type="submit" className="btn btn-primary mt-2">تأكيد</button>
                </div>
              </form>
            </div>
            <hr />
            <div className="modal-body px-5 pb-3">
              ...
              <div className="d-flex justify-content-between align-items-center flex-wrap">
                <div className="d-flex justify-content-center me-1 mb-1">
                  <sup className="h5 pricing-currency pt-1 text-primary">LYD</sup>
                  <h1 className="fw-bolder display-4 mb-0 text-primary me-25">39</h1>
                  <sub className="pricing-duration font-small-4 mt-auto mb-2">/شهر</sub>
                </div>
                <button className="btn btn-outline-danger cancel-subscription mb-1"> إلغاء الإشتراك</button>
              </div>
            </div>
          </div>
        </div>
