...
$(function () {
  ...
  var stAccept = $('#type-stAccept');
  var error = $('#type-error');
  var decline = $('#type-decline');
  ...
  // Student Request
  if (stAccept.length) {
    stAccept.on('click', function () {
      Swal.fire({
        title: 'تمت العملية بنجاح!',
        text: 'تم إرسال طلب التسجيل!',
        icon: 'success',
        customClass: {
          confirmButton: 'btn btn-primary'
        },
